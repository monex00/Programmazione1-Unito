public class SimulazioneAlternativa {
	...
	public static boolean e2(int[] vet, int s){
		boolean risultato = false;
		if(vet != null){
			risultato = e2(vet,0,vet.length , s);
		}
		return risultato;
	}

	private static boolean e2(int[] vet, int l, int r, int s){
		if ( l + 1 == r){
			return vet[l] > s;
		}else{
			int m = (l + r) / 2;
			return e2(vet,l, m, s) || e2(vet,m , r, s);
		}
	}
